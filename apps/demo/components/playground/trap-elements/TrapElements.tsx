...
import { SkeletonButton, SkeletonGroup } from '../../../hooks/useTrapElementsSkeleton';
import { SelectClickedElement } from '../Playground';

interface TrapElementsProps {
  trapElementsSkeletonState: SkeletonGroup;
  setSelectClickedElementState: React.Dispatch<React.SetStateAction<SelectClickedElement>>;
}

export const TrapElements = forwardRef(function TrapElements(
  { trapElementsSkeletonState, setSelectClickedElementState }: TrapElementsProps,
  ref: React.ForwardedRef<HTMLDivElement>
) {
  const { id: rootId, children: rootChildren } = trapElementsSkeletonState;
